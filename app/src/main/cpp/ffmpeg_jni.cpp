//
// Created by Arctan on 2021/1/23.
//
...
Java_com_user_lv_ffmpeg_FFmpegJni_execute(JNIEnv *env, jclass type, jobjectArray commands) {
...
Java_com_user_lv_ffmpeg_FFmpegJni_getLog(JNIEnv *env, jclass type) {
...
Java_com_user_lv_ffmpeg_FFmpegJni_playVideo(JNIEnv *env, jclass type, jstring videoPath_,
                                                 jobject surface) {
